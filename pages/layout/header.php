    ...
    <ul class="flex items-center flex-shrink-0 space-x-6">
        ...
        >
          ...
          <template x-if="dark">
            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
              <path
                fill-rule="evenodd"
                d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zM4 11a1 1 0 100-2H3a1 1 0 000 2h1zm13 0a1 1 0 100-2h-1a1 1 0 100 2h1z"
                clip-rule="evenodd"
              ></path>
            </svg>
          </template>
      ...
      <li class="relative">
        ...
        <template x-if="isNotificationsMenuOpen">
          ...
          >
            <li class="flex">
              <a class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800" href="#">
                <span>Messages</span>
      ...
      <li class="relative">
        ...
        <template x-if="isProfileMenuOpen">
          ...
          >
            <li class="flex">
              <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold hover:bg-gray-100 dark:hover:bg-gray-800" href="#">
            ...
            <li class="flex">
              <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold hover:bg-gray-100 dark:hover:bg-gray-800" href="<?php echo '/' . $host_name . '/management/logout.php'; ?>">
                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
